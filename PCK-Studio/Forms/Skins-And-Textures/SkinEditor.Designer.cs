namespace PckStudio
{
    partial class SkinEditor
    {
        ...
        private void InitializeComponent()
        {
			...
			this.labelSelectSkin = new System.Windows.Forms.Label();
			...
			this.labelSelectCape = new System.Windows.Forms.Label();
			this.buttonAnimGen = new System.Windows.Forms.Button();
			this.buttonViewSkin = new System.Windows.Forms.Button();
			...
			this.freeCheckBox = new MetroFramework.Controls.MetroCheckBox();
			...
			// labelSelectSkin
			// 
			resources.ApplyResources(this.labelSelectSkin, "labelSelectSkin");
			this.labelSelectSkin.ForeColor = System.Drawing.Color.White;
			this.labelSelectSkin.Name = "labelSelectSkin";
			this.labelSelectSkin.Click += new System.EventHandler(this.pictureBox1_Click);
			// 
			// radioSERVER
			// 
			...
			// labelSelectCape
			// 
			resources.ApplyResources(this.labelSelectCape, "labelSelectCape");
			this.labelSelectCape.ForeColor = System.Drawing.Color.White;
			this.labelSelectCape.Name = "labelSelectCape";
			this.labelSelectCape.Click += new System.EventHandler(this.replaceToolStripMenuItem1_Click);
			// 
			// buttonAnimGen
			// 
			...
			// buttonViewSkin
			// 
			resources.ApplyResources(this.buttonViewSkin, "buttonViewSkin");
			this.buttonViewSkin.ForeColor = System.Drawing.Color.White;
			this.buttonViewSkin.Name = "buttonViewSkin";
			this.buttonViewSkin.UseVisualStyleBackColor = true;
			this.buttonViewSkin.Click += new System.EventHandler(this.buttonViewSkin_Click);
			// 
			// capePictureBox
			// 
			...
			// metroCheckBox1
			// 
			resources.ApplyResources(this.freeCheckBox, "metroCheckBox1");
			this.freeCheckBox.Checked = true;
			this.freeCheckBox.CheckState = System.Windows.Forms.CheckState.Checked;
			this.freeCheckBox.Name = "metroCheckBox1";
			this.freeCheckBox.Theme = MetroFramework.MetroThemeStyle.Dark;
			this.freeCheckBox.UseSelectable = true;
			// 
			// SkinEditor
			// 
			...
			this.Controls.Add(this.buttonViewSkin);
			this.Controls.Add(this.buttonAnimGen);
			this.Controls.Add(this.labelSelectCape);
			...
			this.Controls.Add(this.labelSelectSkin);
        ...
        private System.Windows.Forms.Label labelSelectSkin;
		...
		private System.Windows.Forms.Label labelSelectCape;
		private PictureBoxWithInterpolationMode skinPictureBoxTexture;
		private System.Windows.Forms.Button buttonAnimGen;
		private System.Windows.Forms.Button buttonViewSkin;
		private MetroFramework.Controls.MetroCheckBox freeCheckBox;
	}
}