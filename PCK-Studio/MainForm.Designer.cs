namespace PckStudio
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			// viewFileInfoToolStripMenuItem1
			// 
			this.viewFileInfoToolStripMenuItem.Name = "viewFileInfoToolStripMenuItem1";
			resources.ApplyResources(this.viewFileInfoToolStripMenuItem, "viewFileInfoToolStripMenuItem1");
