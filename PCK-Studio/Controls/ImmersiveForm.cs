...
{
    public class ImmersiveForm : Form
    {
        [DllImport("DwmApi")]
        private static extern int DwmSetWindowAttribute(IntPtr hwnd, int attr, int[] attrValue, int attrSize);
        private static int SetWindowAttribute(IntPtr handle, DWMWINDOWATTRIBUTE attribute, int attrSize, params int[] attrValues)
        {
            return DwmSetWindowAttribute(handle, (int)attribute, attrValues, attrSize);
        }
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            {
                if (SetWindowAttribute(Handle, DWMWINDOWATTRIBUTE.DWMWA_USE_IMMERSIVE_DARK_MODE_BEFORE_20H1, sizeof(int), 1) != 0)
                    SetWindowAttribute(Handle, DWMWINDOWATTRIBUTE.DWMWA_USE_IMMERSIVE_DARK_MODE, sizeof(int), 1);
            }
