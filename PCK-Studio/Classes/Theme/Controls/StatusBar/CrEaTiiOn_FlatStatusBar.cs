...
{
    public class CrEaTiiOn_FlatStatusBar : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_iconImage != null)
            {
                ...
                //绘制标题
                //
                graphics.DrawString(Text, new Font("Segoe UI", 12f), new SolidBrush(ThemeColors.FourLevelBorder), new Rectangle(45, 1, Width - 100, Height), StringAlign.Left);
            }
            else
            {
                //
        ...
        public CrEaTiiOn_FlatStatusBar()
        {
