...
namespace PckStudio
{
    public partial class generateModelRENDR : MetroFramework.Forms.MetroForm
    {
        ...
        //Initialization
        public generateModelRENDR(List<object[]> boxesIn, PictureBox preview)
        {
        ...
        private void render()
        {
            ...
            var stream = File.OpenRead("default.png");
            texturePreview.Image.Save(stream, ImageFormat.Png);
            modelBase.textures = new Texture[]
            {
                new Texture((Image)(Bitmap.FromStream(stream)))
            };
        ...
        private void buttonTemplate_Click(object sender, EventArgs e)
        {
          ...
          new ListViewItem.ListViewSubItem(owner, "16")
            ...
            this.comboParent.Enabled = true;
            render();
            texturePreview.Image.Save(Environment.CurrentDirectory + "\\default.png");
